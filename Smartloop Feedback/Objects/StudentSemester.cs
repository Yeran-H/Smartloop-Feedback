...
namespace Smartloop_Feedback
{
    public class StudentSemester
    {
        ...
        public SortedDictionary<int, StudentCourseDEMO> CourseList { get; set; } // List of courses in the semester
        ...
        public StudentSemester(string name, int id, int yearId, int studentId)
        {
            ...
            YearId = yearId;
            StudentId = studentId;
            CourseList = new SortedDictionary<int, StudentCourseDEMO>(); // Initialize the course list
                ...
                using (SqlCommand cmd = new SqlCommand(sql, conn)) // Create a command
                {
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader()) // Execute the query and get a reader
                    {
                        while (reader.Read()) // Read each row
                        {
                            ...
                            CourseList.Add(courseId, new StudentCourseDEMO(courseId, code, title, creditPoint, description, isCompleted, canvasLink, Id, StudentId)); // Add the course to the course list
                        }
                    }
                }
            }
        ...
        public void DeleteSemesterFromDatabase()
        {
            ...
            foreach (StudentCourseDEMO course in CourseList.Values)
            {
