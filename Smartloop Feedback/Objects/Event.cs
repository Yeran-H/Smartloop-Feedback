    ...
    public class Event
    {
        ...
        public void AddEventToDatabase()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr)) // Establish a database connection
            {
                ...
                string sql = "INSERT INTO event (name, date, startTime, endTime, category, color, courseId, studentId) VALUES (@name, @date, @startTime, @endTime, @category, @color, @courseId, @studentId); SELECT SCOPE_IDENTITY();"; // SQL query to insert assessment and get the generated ID
